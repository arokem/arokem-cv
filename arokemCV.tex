...
\textbf{Google Scholar, total citations: 9,128, h-index: 44}
...
\section*{Work in progress, preprints, white papers and commentary}
\begin{enumerate}
...
\begin{tabular}{p{0.15\textwidth}p{0.70\textwidth}p{0.15\textwidth}}
  ...
  2016 -- & \emph{Pulse2percept}: Models for Sight Restoration & \url{https://pulse2percept.github.io/pulse2percept/}\\
