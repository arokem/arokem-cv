...
\begin{tabular}{ll}
  ...
  July 2021 -  & {\bf University of Washington Department of Psychology}\\
...
\section*{Peer-reviewed publications}
  \begin{etaremune}
  \item \bibentry{cieslak2020qsiprep}
...
\section*{Manuscripts in preparation/under review}
\begin{enumerate}
  \item \bibentry{Kiar2020instabilities}
  \item \bibentry{henriques2019dki}
  \item \bibentry{richford2020sgl}
...
\years{2021}: UW Azure Cloud Computing Credits (role: PI), \$15,000\\
\years{2020}: Google Cloud Research Credits (role: PI), \$5,000\\
\years{2019 - 2022} NIH BRAIN Initiative RF1: A data science toolbox for analysis of Human Connectome Project diffusion MRI (role: PI), \$707,444.\\
\years{2019 - 2021} NSF HDR: I-DIRSE-FW: Accelerating the Engineering Design and Manufacturing Life-Cycle with Data Science (role: co-PI; PI: Magda Balazinska), \$2,320,979. \\
\years{2019 - 2024} NIH R01: Aging eyes and aging brains in studying Alzheimer’s disease: modern ophthalmic data collection in the Adult Changes in Thought (ACT) study (role: Senior Personnel; PI: Cecilia Lee). \$3,779,608  \\
...
\years{2009-2010} NIH/National Institute for Aging, National Research Service Award (F31): Neural Mechanisms of Perceptual Learning (role: PI), \$22,253. \\
  ...
  \years{9/2020} Amazon Web Services Education: Research Seminar Series. \\
...
\years{2015 -- } \emph{pyAFQ}: automated quantification of brain white matter fibers \url{https://yeatmanlab.github.io/pyAFQ/}, see also \url{https://autofq.org/}.
...
\item John Kruper, Jason D. Yeatman, Adam Richie-Halford,David Bloom,  Mareike Grotheer, Sendy Caffarra, Gregory Kiar, Iliana I. Karipidis, Ethan Roy, {\bf Ariel Rokem}. Evaluating the reliability of diffusion-MRI based tractometry. Annual Meeting of the Organization for Human Brain Mapping 2021.
...
\years{6/2020} Co-organizer (with Catherine Lebel): ``Tractometry : peering into the white matter'', educational course at the annual meeting of the Organization for Human Brain Mapping
...
\years{5/2019} Co-organizer (with Andrew Doyle): ``Deep Learning in Human Brain Mapping'', educational course at the annual meeting of the Organization for Human Brain Mapping
...
\years{2020 -- } Manjari Narayan (with Jason Yeatman)

\years{2020 -- } Adam Richie-Halford.

\years{2016 -- 2019} Michael Beyeler (with Ione Fine). Currently Assistant
Professor in CS and Neuroscience at the University of California, Santa-Barbara
in Fall 2019.
...
\years{2020 -- } John Kruper (UWIN post-baccalaureate fellow).

\years{2020 -- } David Bloom.
