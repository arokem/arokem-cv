...
\begin{enumerate}
\item \bibentry{lee2017perfusion}
\item \bibentry{tian2017fouriereap}
\item \bibentry{bain2017laterality}
...
\years{2019} TensorFlow Research Cloud credits, 100 TPU hours {role: PI}.\\
...
\years{2018-2021} NIH CRCNS: Community-supported open-source software for computational neuroanatomy. (role: subcontract PI, PI: Eleftherios Garyfallidis), \$ 597,185. \\
...
\years{2017-2023} The Bill \& Melinda Gates Foundation: Advance Data Analytic Support for Strategic PNW Partners by eScience Institute (role: co-PI, PI: Bill Howe), \$750,000. \\
...
\years{2015-2018} NSF BDHUB: A Big Data Innovation Hub for the Western United States (role: co-PI, PI: Ed Lazowska), \$201,822.\\
...
\years{2009-2010} NIH/National Institute for Aging, National Research Service Award (F31): Neural Mechanisms of Perceptual Learning (role: PI), \$22,253. \\
  ...
  \years{9/2019} INCF Neuroinformatics congress, Warsaw, Poland (Invited Keynote) \\
...
\years{2016 -- } Michael Beyeler (with Ione Fine).
...
\years{2017} Chair (with Olivia Guest) mini-symposium in neuroscience,
...
Editorial board member for \emph{Journal of Open Source Software} and \emph{Journal of Open Research Software}. Review Editor for \emph{Frontiers in Human Neuroscience}. Editor, Special Topic: Explicating the interplay between anatomical and functional connectivity in the human brain, \emph{Frontiers in Human Neuroscience} (2015). Program committee member for \emph{Pattern Recognition in Neuroimaging} (2015, 2016), \emph{Scientific Computing in Python} (2016, 2017).
