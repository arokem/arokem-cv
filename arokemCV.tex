...
\textbf{Google Scholar, total citations: 7,838, h-index: 42}
...
\textbf{Full record of open-source software contributions available at \url{https://github.com/arokem}}
...
\years{2022 -- } \emph{Tractable}: Statistical analysis for tractometry data  \url{https://github.com/yeatmanlab/tractable/}.
...
\years{5/2024} (Instructor: Ione Fine)

\years{} Core Graduate seminar, UW Department of Psychology (Instructor: Andrea Stocco)

\years{5/2021} Image Analysis for Data Scientists,  UW Department of Chemical Engineering (Instructor: Chad Curtis)

\years{5/2018} Data Science and Society, UW Department of Sociology (Instructor: Afra Mashhadi)

\years{10/2017} Data Science and Society, UW Department of Sociology (Instructor: Afra Mashhadi)
...
\years{2022 -- 2024} Member, Brain Imaging Data Structure (BIDS) steering grop
