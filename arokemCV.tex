...
\section*{Publications}
  ...
  \item \bibentry{huppenkothen2017hackweeks}
...
\years{2017-2018} NSF ACI SI2-S2I2: Conceptualization: Conceptualizing a US Research Software Sustainability Institute (URSSI) (role: senior Personnel, PI: Daniel Katz).\\
...
\begin{enumerate}
\item NIH BRAINI: Computational and Circuit Mechanisms Underlying Rapid Learning. (role: Co-I, PI: Beth Buffalo) \\
\item NSF CRCNS: Data sharing: Community-supported open-source software, algorithms and derivatives for computational neuroanatomy. (role: co-PI, PI: Eleftherios Garyfallidis)\\
\item NSF NRT-HDR: Linking engineered and evolved algorithms through big data. (role: co-PI, PI: Eric Shea-Brown)\\
\item NSF TRIPODS + X EDU: Foundational training in neuroscience and geoscience via hack weeks (role: co-PI, PI: Maryam Fazel)\\
...
\years{2016 -- 2017} Postdoc mentor (with Magda Balazinska): Dongfang Zhao, UW Department of Computer Science and Engineering, and UW eScience Institute. Currently Assistant Professor at the University of Nevada, Reno.
...
\years{2017 -- } Chair, University of Washington eScience Institute Working Group on Reproducibility and Open Science.
